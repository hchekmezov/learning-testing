...
This does not affect the tests now, but it is not known what will happen in the future (today is 20.04.2023)
"""
...
def init_page_or_uiobject(driver: Remote, base_class):
    ...
    # logger.info("FOR CLASS {} ----------------------------".format(base_class))

    # os.path.basename(os.path.normpath(file_path)) != operating
